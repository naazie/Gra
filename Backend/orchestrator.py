...
async def handle_user_input(user_id: str, text: str) -> dict:
    ...
    # Step 3: Contradiction check — enhanced version with content heuristic
    # + stated vs demonstrated contradiction detection.
    conflict_warning = ""
    if entities:
        try:
            conflict_warning = _get_graph().improve_contradiction_check(
